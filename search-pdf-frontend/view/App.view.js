sap.ui.jsview("view.App", {
    ...
    createContent: function(oController) {
        ...
        this.app.addDetailPage(sap.ui.jsview("PDFDetail", "view.PDFDetail"));
        this.app.addDetailPage(sap.ui.jsview("ChartDetail", "view.ChartDetail"));
